        ...
        with open(vocab_file, 'r') as vocab_f:
            for line in vocab_f:
                ...
                if len(pieces) != 2:
                    ...
                    continue
                w = pieces[0]   #词典中的word peices[0] 出现的次数pieces[1]
                if w in [
                ...
                self._word_to_id[w] = self._count
                self._id_to_word[self._count] = w
                self._count += 1   # 即词典中第一行的词id=4，第二行id=5
    ...
    for w in abstract_words:
        ...
        if i == unk_id:  # If w is an OOV word
            if w in article_oovs:  # If w is an in-article OOV
                ...
                ids.append(unk_id)  # Map to the UNK token id，对于摘要中出现的oov之间将其id表示为0
        else:
            ids.append(i)
    return ids
    ...
    for i in id_list:
        try:
            ...
            try:
                ...
                w = vocab.id2word(article_oov_idx)
